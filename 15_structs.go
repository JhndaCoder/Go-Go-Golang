...
func main() {
	...
	//? While arrays are used to store multiple values of the same data type into
	//? a single variable, structs are used to store multiple values of different data types into a single variable.
